...
namespace Internal {
	...
	const uint8_t INTERNARG=1; //Error resulting from argument mismatch in index.js
	const uint8_t SCRYPT=2; //Scrypt generated errors
	...
	//
	v8::Local<v8::Value> MakeErrorObject(int errCode, const char* errMessage, int scryptErrorCode) {
